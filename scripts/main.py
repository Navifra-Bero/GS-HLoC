...
from pipeline import (
    ...
    step0_align, step1_viewpoints, step2_render,
    step3_global_desc, step4_build_db,
    step5_retrieval, step6_match, step6a_match_viz, step7_pnp,
    run_test_batch,
...
def main():
    ...
    parser.add_argument("--render_mode", default="gs",
                        choices=["pointcloud", "gs"],
                        help="렌더링 방식: pointcloud (O3D) 또는 gs (3DGS)")
