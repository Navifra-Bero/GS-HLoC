...
import os
from utils.gpu_utils import configure_cuda_visible_devices

_selected_gpu, _selected_gpu_source = configure_cuda_visible_devices()
if _selected_gpu is not None:
    print(f"CUDA_VISIBLE_DEVICES={_selected_gpu} ({_selected_gpu_source})")
else:
    print("CUDA_VISIBLE_DEVICES not set; using default CUDA device visibility")
...
if __name__ == "__main__":
    ...
    if _selected_gpu is not None:
        logger.info(f'using GPU {_selected_gpu} ({_selected_gpu_source})')
    else:
        logger.info('CUDA_VISIBLE_DEVICES not set; using default CUDA device visibility')
